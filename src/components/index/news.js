  ...
  return (
    <section id="front-news" className="bg-light-blue relative">
        ...
        <div className="bg-white mt-8 rounded-[12px] relative max-w-[580px] mx-auto">
          ...
          {newsList.map((list, i) => {
            return (
              ...
              >
                <time dateTime={list.timeZone} className="text-[12px]">
                  {list.time}
                </time>
                <p className="py-2 text-center underline underline-offset-2">
                  {list.text}
                </p>
      ...
      <div className="flex justify-center pb-20">
        <Link
          className="news-btn mt-12 inline-block py-2 px-8 text-white text-[14px] font-semibold rounded-[22px]"
          to={'/news-list'}
        >
          お知らせ一覧 ▶
        </Link>
