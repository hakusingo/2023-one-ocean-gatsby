      ...
      <div className="relative">
        <div className="">
          {/* <StaticImage
            ...
            src="../../images/intro/intro-kayak-couple.svg"
            alt="カヤック2人のり"
          /> */}
          <KayakCouple
            className="bort1 absolute bottom-4 left-[3%] z-10 sm:left-[40%]"
          ...
          {/* <StaticImage
            className="bort2 absolute bottom-4 left-[38%] sm:left-[54%] lg:left-[50%] z-0"
            src="../../images/intro/intro-kayak-single.svg"
            alt="カヤック1人のり"
          /> */}
          <Mangrove
        ...
        <div className="pt-[4rem] pl-4 pr-4 pb-[12rem] sm:pb-[8rem] relative sm:flex justify-evenly max-w-[1380px] mx-auto lg:gap-8">
          <div className="">
            ...
            <div className="flex justify-center">
              <StaticImage
                className="iso-target max-w-[400px] h-auto"
            ...
            <div className="">
              ...
              <div className="flex justify-center lg:justify-start">
                <p className="font-black iso-target fadein-opacity mt-8 leading-[28px] w-[90%] max-w-[400px] lg:max-w-[600px] lg:text-[18px]">
                  ...
                  <br />
                  完全貸切となっていますので、プライベートでゆったり安心してご利用頂いております。<br />
                  <br />
