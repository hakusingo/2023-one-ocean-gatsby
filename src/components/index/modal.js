  ...
  return (
    modal ? (
      ...
      <div className='absolute top-0 bottom-0 left-0 right-0 z-20'>
        ...
        <div className="modal-animation w-[90%] h-[80vh] bg-white left-[50%] top-[50%] -translate-x-[6%] -translate-y-[46%] sticky z-30 rounded xl:-translate-x-[calc((100vw-1000px-120px)/2)] xl:max-w-[1000px]">
          <button 
            onClick={(() => {
              modalState(true)
            })}
          ...
          <div className="pt-8 flex justify-center">
            <div className="w-[80%] h-full max-w-[400px] xl:max-w-[800px]">
              <svg 
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88.74 23.01"
                className='w-[80%] h-auto mx-auto max-w-[400px]'
              >
                <defs>
              ...
              <div className="xl:flex gap-8 xl:text-[20px]">
                <StaticImage
                  className="mt-4 w-[60%] block mx-auto rounded flex-1 xl:max-w-[300px]"
