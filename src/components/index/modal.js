  ...
  return (
    modal ? (
      ...
      <div className='absolute top-0 bottom-0 left-0 right-0 z-20'>
        ...
        <div className="modal-animation w-[90%] md:w-[80%] h-[80vh] bg-white left-[50%] top-[50%] -translate-x-[50%] -translate-y-[46%] fixed z-30 rounded-lg xl:max-w-[1000px] overflow-hidden">
          <button 
            onClick={(() => {
              modalState(true)
              document.querySelector("body").classList.remove("overflow-hidden")
