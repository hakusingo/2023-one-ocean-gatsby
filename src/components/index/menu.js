...
const Menu = () => {
  ...
  const menuList = [
    {
      header: "１歳からでも参加できる!!",
      imgSrc: "../../images/tour-menu/menu-kayak.jpg",
      imgAlt: "マングローブカヤック",
      textHeader: "マングローブカヤック",
      textContents: "神秘的な沖縄の大自然。\nそのなかでもマングローブは、大自然の植物や動物の宝庫です。\nマングローブのトンネルをぬける景色は幻想的で、大人気のアドベンチャーです。",
      pngSrc: "../../images/tour-menu/menu-kayak.png",
      pngAlt: "親子カヤック写真",
      linkUrl: "/",
    }
  ]
        ...
        <div className="">
          <div className="md:flex md:gap-[1rem] lg:justify-center max-w-[1200px] mx-auto">
            ...
            {menuList.map((props, i) => {
              return (
                <div className="iso-target fadein-opacity pt-12 max-w-[400px] mx-auto lg:max-w-[500px]" key={i}>
